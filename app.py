...
LISTAS_BANCOS = {
    ...
    "TL": ["Amigoz", "Banrisul", "Banco do Brasil", "BMG", "BRB", "BTW", "CBA", "C6 Bank", "Capital", "CredFranco", "Crefisa", "Digio", "Facta", "Futuro Previdência", "GVN", "Happy", "iCred", "Itaú", "Mercantil, "Lecca", "Nossa Fintech", "Pan", "Santander", "ZiliCred", "Safra"],
